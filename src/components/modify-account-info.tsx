        ...
        <Card className="bg-white/50 backdrop-blur-sm rounded-2xl">
          ...
          <CardContent className="space-y-4">
              <div className="space-y-2">
                  ...
                  <Input id="firstName" defaultValue={props.profileData?.first_name} ref={firstNameRef} />
              </div>
              <div className="space-y-2">
                  <label htmlFor="lastName" className="text-sm font-medium">
                      Last Name
                  </label>
                  <Input id="lastName" defaultValue={props.profileData?.last_name} ref={lastNameRef} />
              </div>
              <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-medium">
                      Email
                  </label>
                  <Input id="email" type="email" defaultValue={props.profileData?.email} ref={emailRef}/>
              </div>
          </CardContent>
          <CardFooter>
